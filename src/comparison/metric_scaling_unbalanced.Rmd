...
cols <-c(c(jcolors('pal6'),jcolors('pal8'), jcolors('pal7'))[c(12,18,1,2,25,27,4,7,3,6,8,14,9,20)],jcolors('pal4'))
names(cols) <- c()
```
...
ind_int_batch <- grep("_0.7$", names(mean_tab))
...
ggplot(lim_long, aes(x = metric , y = unbalanced_limit, fill = dataset)) + 
